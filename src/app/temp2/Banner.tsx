...
const Banner: React.FC = () => {
  return (
    <div className="bg-black border-2 border-transparent py-6 px-4 md:px-16 lg:px-32 h-auto md:h-[139px] flex flex-col justify-center items-center gap-4 md:gap-6 lg:gap-2.5">
