...
function Contact({ contactInfo }: { contactInfo: any }) {
  return (
    <div className="flex mt-5 justify-between h-[400px] relative overflow-hidden bg-[#1b1b1b] border-2 p-5 border-neutral-800 rounded-xl">
      <div className="w-full flex flex-col z-10 gap-8 justify-center items-center text-center">
        <h1 className="text-white text-4xl font-semibold">{contactInfo.contactHeading || 'Have an idea about a project?'}</h1>
        <p className="text-[#c0c0c0] text-lg font-normal">{contactInfo.contactDescription || 'Write something here about your work or what you are targeting.'}</p>
        <a href={contactInfo.contactLink || 'mailto:your-email@example.com'}>
      ...
      <div className="w-full h-full absolute sm:opacity-55 opacity-25 flex justify-end pr-9 items-center">
        ...
        >
          ...
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M195.5 219C195.469 210.45 188.541 203.529 180 203.529C188.56 203.529 195.5 196.576 195.5 188C195.531 196.55 202.459 203.471 211 203.471C202.439 203.471 195.5 210.424 195.5 219Z"
            fill="white"
          />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M275.5 306C275.469 297.45 268.541 290.529 260 290.529C268.56 290.529 275.5 283.576 275.5 275C275.531 283.55 282.459 290.471 291 290.471C282.439 290.471 275.5 297.424 275.5 306Z"
            fill="white"
          />
        </svg>
      </div>
