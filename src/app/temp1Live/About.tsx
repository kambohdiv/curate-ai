...
function About() {
  ...
  // Handle the case where the data hasn't been fetched yet
  if (!profileData) {
      ...
      <div className="flex md:flex-row flex-col-reverse justify-between md:items-center items-start gap-6">
        <div className="flex flex-col relative justify-center items-start gap-2">
          ...
          <div className="flex gap-2 pt-4">
            ...
            <a href={profileData?.mailtoLink} className="hover:bg-[#e63e21c6] shadow-[0px_1px_37px_0px_#e63e21af] bg-[#e63e21] border-2 border-[#171717] rounded-md flex justify-center items-center">
            ...
            <button  onClick={copyEmailToClipboard} className='bg-[#171717] border-2 border-[#3f3e3e] rounded-md flex justify-center items-center'>
            ...
            {/* Show copied message if email is copied */}
            {/* {copied && <div className="text-green-500 ml-2">Copied!</div>} */}
          </div>
        </div>
        <div className="w-[178px] h-[178px] bg-[#2c2c2c] flex justify-center items-center rounded-full border mr-5 border-[#3f3e3e]">
          <div className="w-[150px] h-[150px] bg-[#2c2c2c] relative rounded-full border border-[#3f3e3e]">
            <img src={profileData?.imageUrl} alt="profile" className="rounded-full w-[150px] h-[150px]" />
