  ...
  return (
    <>
      <div className="bg-[#2c2c2c] w-full space-y-5 text-center py-6">
        <div className="ClashDisplay-Medium text-xl sm:text-2xl">What section of your portfolio do you want to enhance today?</div>
      ...
      <div className="py-8 bg-[#1e1e1e] relative overflow-hidden hide-scroll">
        <div className="ClashDisplay-Medium text-xl sm:text-2xl pl-4 sm:pl-9">Choose Portfolio Section</div>
        <div className="flex gap-4 overflow-x-auto w-full p-3 sm:px-9 relative">
          <div className="bg-gradient-to-r from-[#139EBC] to-[#AA1ECD] p-[2px] min-w-[280px] sm:min-w-[370px] rounded-xl">
            <div className="h-[160px] sm:h-[180px] w-full bg-neutral-700 rounded-[10px] p-3 space-y-1">
              <img src="/portfolio.svg" alt="Portfolio Icon" />
              <div className="ClashDisplay-Semibold text-base sm:text-lg tracking-wider">Introduction</div>
          ...
          <div className="h-[160px] sm:h-[180px] min-w-[280px] sm:min-w-[374px] bg-neutral-700 rounded-[10px] border-2 border-[#575757] p-3 space-y-1">
            ...
            <div className='ClashDisplay-Reguler text-sm sm:text-base'>Gather and display testimonials from previous clients to build trust and credibility.</div>
          </div>
        </div>

        <div className=''>
          <div className='ClashDisplay-Medium text-xl sm:text-2xl pl-4 sm:pl-9 pt-9'>Projects</div>
